...
function winPopup() {
  ...
  const animationWin = lottie.loadAnimation({
    container: document.querySelector('.popup__animation--win'),
    renderer: 'svg',
    loop: true,
    autoplay: true,
...
function chancePopup() {
  ...
  const animation = lottie.loadAnimation({
    container: document.querySelector('.popup__animation'),
    renderer: 'svg',
    loop: true,
    autoplay: true,
    path: '/lottery/img/smile.json' // the path to the animation json 
  });
